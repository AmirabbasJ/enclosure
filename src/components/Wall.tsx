...
export const WALL_PATHS = {
  ...
  /** D → L → U → L → U */
  zigzagTall: ['D', 'L', 'U', 'L', 'U'] as const satisfies ReadonlyArray<WallDir>,
  /** D → L → U → L → D → L */
  snake: ['D', 'L', 'U', 'L', 'D', 'L'] as const satisfies ReadonlyArray<WallDir>,
  /** D → L → D → L */
...
export function Wall({
  ...
  return (
    <group ref={groupRef} position={position} rotation={[rotation[0], 0, rotation[2]]}>
